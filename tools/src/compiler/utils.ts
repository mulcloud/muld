...
import { SRC_DIR, PACKAGE_JSON_FILE, MULD_CONFIG_FILE } from '../config/constant';
...
export function getMuldConfig() {
    delete require.cache[MULD_CONFIG_FILE];
    try {
        return require(MULD_CONFIG_FILE);
    } catch (err) {
        return {};
    }
}
