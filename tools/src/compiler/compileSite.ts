...
import { getSiteDevConfig } from '../config/webpack.dev';
import { getSitePrdConfig } from '../config/webpack.prd';
import { GREEN } from '../config/constant';

function logServerInfo(port: number): void {
...
function runDevServer(port: number, config: ReturnType<typeof getSiteDevConfig>): void {
